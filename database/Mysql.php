...
use DB\Mysql\Database_Mysql_Statement;
use DB\Mysql\Database_Mysql_Exception;
...
class Database_Mysql
{
    ...
    public function get_single_value($sql) {
    ...
    public function insert($table, $aData) {
      $this->query('INSERT INTO `' . $table . '` SET ?As', $aData);
      return $this->getLastInsertId();
    }
    
    public function update($table, $aData, $sConditions) {
      $this->query("UPDATE `" . $table . "` SET ?As WHERE " . $sConditions, $aData);
    }
