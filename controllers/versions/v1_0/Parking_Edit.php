...
class Parking_Edit extends AuthControl {
  ...
  private function process() {
    ...
    $this->parking_db_edit();
  }

  private function check_post_params() {
    $this->aParams = ['park_title', 'address', 'places_qty', 'rect_min_x', 'rect_min_y', 'rect_max_x', 'rect_max_y', 'center_x', 'center_y', 'park_code', 'user_id', 'parent_id'];
  ...
  private function parking_db_edit() {
    $aData = [
      'park_title' => $this->aPost['park_title'],
      'address' => $this->aPost['address'],
      'places_qty' => $this->aPost['places_qty'],
      'rect_min_x' => $this->aPost['rect_min_x'],
      'rect_min_y' => $this->aPost['rect_min_y'],
      'rect_max_x' => $this->aPost['rect_max_x'],
      'rect_max_y' => $this->aPost['rect_max_y'],
    ...
    $this->objCont->db->update('parking', $aData, $sConditions);

    $this->aAnswer = [
      'http' => 200,
      'data' => [
        'success' => 'Parking was updated sucessfully',
      ],
    ];
  }
